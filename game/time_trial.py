...
def main():
    ...
    model_configs = [
        ("game/control/models/a2c_best_model.zip", "A2C-B-1"),
        ("game/control/models/a2c_best_model.zip", "A2C-B-2"),
        ("game/control/models/a2c_best_model2.zip", "A2C-B2-1"),
        ("game/control/models/a2c_best_model2.zip", "A2C-B2-2"),
        (None, "RB-1"),
        (None, "RB-2"),
    ]
